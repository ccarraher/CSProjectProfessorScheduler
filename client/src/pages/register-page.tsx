...
export const RegisterPage = () => {
    ...
    const defaultValues = {firstName: '', lastName: '', username: '', password: '', password2: ''}
            ...
            <Paper sx={{width: '500px', padding: '32px'}}>
                <FormProvider {...methods}>
                    <Box onSubmit={handleSubmit(register)} component="form" sx={{display: 'flex', flexDirection: 'column', gap: theme.spacing(4)}}>
                        ...
                        <RhfTextField name={RegisterFormFieldNames.firstName} label="First Name" muiProps={{required: true}} />
                        <RhfTextField name={RegisterFormFieldNames.lastName} label="Last Name" muiProps={{required: true}} />
